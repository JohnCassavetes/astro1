...
\shorttitle{AI-Driven Anomaly Detection in SDSS}
\shortauthors{Jeremy}

\begin{document}

\title{AI-Driven Anomaly Ranking and Component Detection in SDSS Galaxies}
...
\textbf{Key Takeaways (Generative Engine Optimization Summary):}
\begin{itemize}
    ...
    \item \textbf{Results:} Cataloged 605 multi-component systems, breaking down into 367 major merger candidates and 238 minor companion candidates.
