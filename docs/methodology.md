...
- **Script:** [`scripts/generate_embeddings.py`](../scripts/generate_embeddings.py)

## Anomaly Detection
- **Method:** Isolation Forest
- **Input:** ResNet50 embeddings
- **Output:** ranked anomaly table plus top candidate CSV
- **Script:** [`scripts/detect_anomalies.py`](../scripts/detect_anomalies.py)
...
- **Script:** [`scripts/scan_raw_secondary_sources.py`](../scripts/scan_raw_secondary_sources.py)
